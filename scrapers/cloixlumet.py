"""scrapers/cloixlumet.py — Cloix & Lumet Immobilier (Bourges, 18)
...
Stock observé : ~69 biens résidentiels 18 (Cher).
...
BASE_URL = "https://www.cloixlumet.net"


async def search(criteres: dict) -> list[dict]:
    return await netty_search(
        criteres, BASE_URL, source="cloixlumet",
        agence="Cloix & Lumet Immobilier", label="CloixLumet",
    )


if __name__ == "__main__":
    from scrapers._base import standalone_main
    standalone_main(search, "Cloix & Lumet Immobilier")
